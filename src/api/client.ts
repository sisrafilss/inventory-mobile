...
export const DEFAULT_API_URL = process.env.EXPO_PUBLIC_API_URL || 'https://inventory-backend-sisrafilss-projects.vercel.app/api'; // Official Production Vercel Backend
