...
export const DEFAULT_API_URL = 'http://10.0.2.2:5000/api'; // Android Emulator default
// For physical Android phones on same WiFi, set your PC's IP, e.g. http://192.168.0.100:5000/api
